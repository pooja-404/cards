                ...
                <Container className="mt-5">
                    <Row className="mt-5 align-items-center">
                        <Col lg={6}>
                            ...
                            <div>
                                <p className="fs-sm1 fw-normal ff-poppins text-white mw-358 pt-sm-5 pt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc efficitur urna in dictum suscipit. Suspendisse maximus ipsum sem. c</p>
                            </div>
                            <div className=" d-flex gap-2">
                                <span className="corsour-pointer">
                        ...
                        <Col lg={6} className="pt-5 pt-lg-0">
                            <Row>
                                <Col lg={3} xs={6}>
                                    <p href="" className="fs-sm1 fw-bold ff-poppins text-white mb-0 ">SERVICES</p>
                                    <ul className="ps-0">
                                        <li className="pt-3"> <a href="" className="fs-sm fw-normal ff-poppins text-white ">About</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white ">NEWS</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white ">ullamcorper</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white ">Contact</a></li>
                                    </ul>
                                </Col>
                                <Col lg={3} xs={6}>
                                    <p href="" className="fs-sm1 fw-bold ff-poppins text-white mb-0">EVENTS</p>
                                    <ul className="ps-0">
                                        <li className="pt-3"><a href="" className="fs-sm fw-normal ff-poppins text-white">ullamcorper</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white">ullamcorper</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white">ullamcorper</a></li>
                                        <li className="pt-2"><a href="" className="fs-sm fw-normal ff-poppins text-white">ullamcorper</a></li>
                                    </ul>
                                </Col>
                                <Col lg={6} xs={12} sm={6} className="pt-5 pt-lg-0">
                                    <ul>
                                        <p href="" className="fs-sm1 fw-bold ff-poppins text-white mb-0">GALLERY</p>
                                        <li>
                                            <ul className=" ps-0">
                                                <Row className="pt-3">
                                                    <Col xs={4}>
                                                        <li className=" mb-13"><a href=""><img className="w-100" src={footerimg1} alt="footer-gallery-image" /></a></li>
                                                    </Col>
                                                    <Col xs={4}>
                                                        <li className=" mb-13"><a href=""><img className="w-100" src={footerimg2} alt="footer-gallery-image" /></a></li>
                                                    </Col>
                                                    <Col xs={4}>
                                                        <li className=" mb-13"><a href=""><img className="w-100" src={footerimg3} alt="footer-gallery-image" /></a></li>
                                                    </Col>
                                                    <Col xs={4}>
                                                        <li className=" pt-3"><a href=""><img className="w-100" src={footerimg4} alt="footer-gallery-image" /></a></li>
                                                    </Col>
                                                    <Col xs={4}>
                                                        <li className="pt-3"><a href=""> <img className="w-100" src={footerimg5} alt="footer-gallery-image" /></a></li>
                                                    </Col>
                                                    <Col xs={4}>
                                                        <li className="pt-3 h-100"><a className="h-100" href=""><p className="background-blue h-100 f-showmore mb-0">Show More</p></a></li>
                                                    </Col>
                                                </Row>
                                            </ul>
                                        </li>
                    ...
                    <p className=" text-center fs-sm1 fw-normal ff-poppins text-white m-0 pb-4 pt-5"> © Credits of companyName belong to companyName.</p>
                </Container>
            </footer>
        </div>
    )
